import { useStore as useThemeStore } from "../states/theme";
import { useStore as useUserStore } from "../states/user";
              ...
              <ul className="navbar-nav">
                ...
                >
                  ...
                  <div className="dropdown-menu">
                    ...
                    <Link
                      className={`dropdown-item ${location.pathname === "/products" ? "active" : ""} `}
                      to="/products"
                    >
                      Products
                    </Link>
